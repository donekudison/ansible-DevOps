...
## Contents
 ...
 3. [Advanced Options](#advanced-options)
  ...
  3. [Building 64-bit binaries](#building-64-bit-binaries)
 4. [Role Variables](#role-variables)

## Installation

``` bash
$ ansible-galaxy install redis-install-repo
```
...
To build 64-bit binaries of Redis (which can be used for [memory optimization](https://redis.io/topics/memory-optimization)), set `redis_make_64bit: true`. 
This installs the necessary dependencies (x86 glibc) on RHEL and sets the option '64bit' when running make.
